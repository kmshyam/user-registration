...
import classes from "./EditPersonalInformation.module.css";
...
import { randomFiveDigNum, randomTwoDigNum } from "../../../../../Utils/unique";
...
const EditPersonalInformation = () => {
  ...
  useEffect(() => {
    ...
    dispatchFn({ type: "UPDATE_STORED_DATA", payload: userPersonalData });
  }, []);
