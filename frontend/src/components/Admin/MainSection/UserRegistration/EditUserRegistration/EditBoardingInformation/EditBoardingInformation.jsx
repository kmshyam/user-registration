...
import classes from "./EditBoardingInformation.module.css";
...
const EditBoardingInformation = () => {
  ...
  useEffect(() => {
    ...
    dispatchFn({ type: "UPDATE_STORED_DATA", payload: userBoardingData });
  }, []);
  ...
  const previousNavigateHandler = (e) => {
    ...
    navigate(
      `/user/registration/edit/personal_info?userId=${sessionStorage.getItem(
        "userId"
      )}`
    );
  };
...
export default EditBoardingInformation;
